//
//  V_Register_NonMemberRegularHeightView.swift
//  Register form
//
...
struct V_Register_NonMemberRegularHeightView: View {
...
#Preview {
    V_Register_NonMemberRegularHeightView(viewModel: .init(registerService: MockRegisterUseCase()), showBottomSheetSuccess: .constant(false))
}
